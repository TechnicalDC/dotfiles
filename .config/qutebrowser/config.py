...
# --- Hints ---
c.colors.hints.bg = catppuccin_colors["base"]
c.colors.hints.fg = catppuccin_colors["surface0"]
c.colors.hints.match.fg = catppuccin_colors["text"]
...
c.colors.messages.warning.bg = catppuccin_colors["yellow"]
...
c.colors.statusbar.insert.bg = catppuccin_colors["mauve"]
...
c.colors.statusbar.url.warn.fg = catppuccin_colors["yellow"]
...
c.colors.tabs.selected.odd.fg = catppuccin_colors["base"]
c.colors.tabs.selected.even.bg = catppuccin_colors["surface0"]
c.colors.tabs.selected.even.fg = catppuccin_colors["base"]
