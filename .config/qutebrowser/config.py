...
c.fonts.default_family = '11px "JetBrainsMonoNL Nerd Font"'
c.fonts.default_size = '11px'
c.fonts.contextmenu = '11px "JetBrainsMonoNL Nerd Font"'
c.fonts.completion.entry = '11px "JetBrainsMonoNL Nerd Font"'    # Font used in the completion widget.
c.fonts.debug_console = '11px "JetBrainsMonoNL Nerd Font"'       # Font used for the debugging console.
c.fonts.prompts = 'default_size FantasqueSansMono Nerd Font'       # Font used for prompts.
c.fonts.statusbar = '11px "JetBrainsMonoNL Nerd Font"'           # Font used in the statusbar.
